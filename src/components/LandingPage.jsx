    ...
    <div id='Land' className="relative h-screen w-screen flex justify-start items-center overflow-hidden">
      ...
      <div className="relative flex flex-col gap-8 px-4 md:px-[75px] items-start ml-4 md:ml-20 justify-center h-fit w-fit max-w-4xl z-10">
        ...
        >
          ...
          >
            Stop waiting weeks for your event photos. Our platform makes the process seamless<h2 className="text-royal-gold">Upload - Scan QR - Download</h2><br /> No more chasing photographers or sharing links.
          </motion.p>
          <motion.div 
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <button disabled className="px-8 py-4 text-base md:text-lg text-royal-gold/50 font-semibold bg-transparent border-2 border-royal-gold/30 rounded-lg transition-all duration-300 cursor-not-allowed text-center block">
